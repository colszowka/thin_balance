...
Run multiple thin instances of your app load-balanced using pen in development
...
In your Rails app´s root dir, invoke:
    
  thin_balance
    
This will fire up 3 thin instances of your app, running on ports 3001-3003 as well
as the pen round-robin load balancer on port 3000, so when you go to localhost:3000,
you will in fact have all 3 thin instances in use.
...
on ports 5001-5005
  ...
  $ thin_balance -e production / --environment production
